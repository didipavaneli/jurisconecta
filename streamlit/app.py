...
PROFILE_NAME = os.environ.get("AWS_PROFILE", "grupo2")
...
#alterar
st.set_page_config(
   page_title="JURISCONECTA - A conexão inteligente para seu direito!",
   page_icon="logo.jpeg",
   layout="wide",
...
def get_boto3_client(service_name, region_name='us-east-1', profile_name='grupo2'):
    """
    ...
    if not st.session_state["password_correct"]:
        ...
        st.markdown("""
            <style>
                ...
                /* Remover o espaço em branco padrão do Streamlit */
                .block-container {
                ...
                /* Ocultar o menu principal e o rodapé do Streamlit para página de login */
                #MainMenu, footer {
                    visibility: hidden;
                }
                /* Estilo adicional para garantir centralização da imagem */
                .logo-container {
                    display: flex;
        ...
        # Adicionar um container para o logo e o formulário de login
        with st.container():
            # Criar a forma de login
            col1, col2, col3 = st.columns([1, 3, 1])
            
            with col2:
                # Adicionar o logotipo antes do formulário                
                logo_path = "logo.jpeg"   # Alterado para usar logo.jpeg
                try:
                    # Adicionando um div para melhor centralização
...
if check_password():
    ...
    with st.sidebar:
        ...
        with col2:
            st.markdown('<h2 style="margin-top: 0;">JURISCONECTA</h2>', unsafe_allow_html=True)
        ...
        rag_checkbox_container = st.empty()
